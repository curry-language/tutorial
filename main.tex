...
% ------------------------------------------------------------------
\newcommand{\curry}%
  {\href{http://www.informatik.uni-kiel.de/~curry}{Curry}}
\newcommand{\pakcs}%
...
\Large
\href{mailto:antoy@cs.pdx.edu}{Sergio Antoy}\\[1ex]
\large
\href{http://www.pdx.edu}{Portland State University}, U.S.A.\\
Email: \url{antoy@cs.pdx.edu}\\
Web: \url{http://www.cs.pdx.edu/~antoy/}\\[3ex]
\Large
\href{mailto:mh@informatik.uni-kiel.de}{Michael Hanus}\\[1ex]
\large
\href{http://www.uni-kiel.de}{Christian-Albrechts-Universit\"at Kiel}, Germany\\
Email: \url{mh@informatik.uni-kiel.de}\\
...
The \href{http://www.informatik.uni-kiel.de/~curry/report.html}
