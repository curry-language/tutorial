...
There is a function, \code{findall}\pindex{findall}
(predefined in the library \code{Findall})
...
The distinguished symbol that terminate a string is a period.
%
\begin{prog}
