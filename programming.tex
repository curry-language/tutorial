...
part of the package \code{setfunctions},\index{package!setfunctions}
this package must be installed as a dependency
with the Curry package manager, e.g., by the command
\ccode{cypm add setfunctions}, see also
...
%TODO re-add the trie using something else or wait for xymatrix support
%\hspace*{2in}
